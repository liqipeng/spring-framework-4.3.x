...
public class ProxyingInstantiator<T> implements org.springframework.objenesis.instantiator.ObjectInstantiator<T> {
   ...
   private static final byte[] CODE = { org.springframework.objenesis.instantiator.util.ClassDefinitionUtils.OPS_aload_0, org.springframework.objenesis.instantiator.util.ClassDefinitionUtils.OPS_return};
   ...
   public ProxyingInstantiator(Class<T> type) {
      ...
      try {
         newType = org.springframework.objenesis.instantiator.util.ClassDefinitionUtils.defineClass(type.getName() + SUFFIX, classBytes, type.getClassLoader());
      } catch (Exception e) {
   ...
   private static byte[] writeExtendingClass(Class<?> type, String suffix) {
      String parentClazz = org.springframework.objenesis.instantiator.util.ClassDefinitionUtils.classNameToInternalClassName(type.getName());
      ...
      try {
         ...
         in.writeShort(org.springframework.objenesis.instantiator.util.ClassDefinitionUtils.ACC_PUBLIC | org.springframework.objenesis.instantiator.util.ClassDefinitionUtils.ACC_SUPER);
