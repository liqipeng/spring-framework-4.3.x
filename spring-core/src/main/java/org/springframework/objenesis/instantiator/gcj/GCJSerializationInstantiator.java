 ...
 */
@Instantiator(org.springframework.objenesis.instantiator.annotations.Typology.SERIALIZATION)
public class GCJSerializationInstantiator<T> extends org.springframework.objenesis.instantiator.gcj.GCJInstantiatorBase<T> {
